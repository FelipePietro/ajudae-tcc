...
<head>
    ...
    <title>Termos de Uso | Ajudaê</title>
        ...
        <div class="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[250px_minmax(0,1fr)]">
            ...
            <article class="min-w-0">
                <header class="rounded-2xl border border-[#DED9CE] bg-white p-6 shadow-sm sm:p-8">
                    <p class="font-poppins text-xs font-semibold uppercase tracking-[0.15em] text-[#D99110]">Ajudaê</p>
                    <h1 class="mt-2 font-fraunces text-3xl font-bold text-[#173F2D] sm:text-4xl">Termos de Uso da Plataforma Ajudaê</h1>
                    <p class="mt-4 max-w-3xl font-poppins text-sm leading-7 text-[#66625B]">
                        Estes Termos de Uso regulam o acesso e a utilização da plataforma Ajudaê. Ao criar uma conta ou utilizar a plataforma, o usuário declara ter lido, compreendido e concordado com as condições abaixo.
                    </p>
                </header>
                ...
                <div class="mt-6 space-y-5 font-poppins text-sm leading-7 text-[#55534D]">
                    <section id="sobre" data-termo-section class="scroll-mt-24 rounded-2xl border border-[#DED9CE] bg-white p-6 sm:p-8">
                        <h2 class="font-fraunces text-2xl font-bold text-[#173F2D]">1. Sobre o Ajudaê</h2>
                        <p class="mt-4">O Ajudaê é uma plataforma digital destinada a facilitar a conexão entre pessoas interessadas em realizar atividades voluntárias e organizações ou responsáveis por eventos, projetos e ações de interesse social.</p>
                    ...
                    <section id="idade" data-termo-section class="scroll-mt-24 rounded-2xl border border-[#E2C98E] bg-[#FFF9EB] p-6 sm:p-8">
                        ...
                        <p class="mt-4">O Ajudaê é destinado exclusivamente a pessoas com <strong>18 anos de idade ou mais</strong>.</p>
                    ...
                    <section id="voluntariado" data-termo-section class="scroll-mt-24 rounded-2xl border border-[#DED9CE] bg-white p-6 sm:p-8">
                        ...
                        <p class="mt-3">Estes Termos de Uso regulam a relação entre o usuário e a plataforma Ajudaê, mas não substituem eventual termo de adesão ao serviço voluntário celebrado entre o voluntário e a entidade responsável pela atividade.</p>
                    </section>
                    ...
                    <section id="responsabilidades" data-termo-section class="scroll-mt-24 rounded-2xl border border-[#DED9CE] bg-white p-6 sm:p-8">
                        ...
                        <p class="mt-4">Salvo quando expressamente indicado de forma diferente, o Ajudaê atua como plataforma de intermediação e organização digital.</p>
                    ...
                    <section id="privacidade" data-termo-section class="scroll-mt-24 rounded-2xl border border-[#DED9CE] bg-white p-6 sm:p-8">
                        ...
                        <p class="mt-4">O Ajudaê poderá tratar dados pessoais necessários ao funcionamento da plataforma, incluindo dados cadastrais, contato, identificação, histórico de participação e registros técnicos.</p>
                        <p class="mt-3">Informações detalhadas deverão constar na Política de Privacidade do Ajudaê.</p>
                    </section>
                    ...
                    <section id="contas" data-termo-section class="scroll-mt-24 rounded-2xl border border-[#DED9CE] bg-white p-6 sm:p-8">
                        ...
                        <p class="mt-4">O Ajudaê poderá advertir, restringir, suspender ou excluir contas que violem estes Termos, pratiquem fraude, utilizem informações falsas ou representem risco à segurança.</p>
                    ...
                    <section id="alteracoes" data-termo-section class="scroll-mt-24 rounded-2xl border border-[#DED9CE] bg-white p-6 sm:p-8">
                        ...
                        <p class="mt-4">O Ajudaê poderá atualizar estes Termos para refletir mudanças legais, de segurança, operação ou novas funcionalidades.</p>
                    ...
                    <section id="contato" data-termo-section class="scroll-mt-24 rounded-2xl border border-[#DED9CE] bg-white p-6 sm:p-8">
                        ...
                        <p class="mt-4">Dúvidas sobre estes Termos poderão ser encaminhadas pelos canais oficiais do Ajudaê.</p>
